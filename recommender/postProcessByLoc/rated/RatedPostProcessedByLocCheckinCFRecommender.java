...
public class RatedPostProcessedByLocCheckinCFRecommender extends PostProcessedByLocCheckinCFRecommender {

	public RatedPostProcessedByLocCheckinCFRecommender(Integer numberOfSimilarUsers,
