...
public class RatedPostProcessedByLocCheckinCFWeightedRecommender extends RatedPostProcessedByLocCheckinCFRecommender {

	public RatedPostProcessedByLocCheckinCFWeightedRecommender(Integer numberOfSimilarUsers,
