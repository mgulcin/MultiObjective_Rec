...
public class ClusteredByFriendshipMOUSCheckinSocNwHometownFineTunedRecommender extends
Recommender {

	public ClusteredByFriendshipMOUSCheckinSocNwHometownFineTunedRecommender(
	...
	public ArrayList<Integer> getMostSimilarUsers(ArrayList<Similarity> userSimVals,
		...
		sortOrder.add(SimType.HOMETOWN); 
