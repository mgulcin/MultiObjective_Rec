...
public class PostProcessedByTimeSocNwCFRecommender extends PostProcessByTimeRecommender{

	public PostProcessedByTimeSocNwCFRecommender(Integer numberOfSimilarUsers,
