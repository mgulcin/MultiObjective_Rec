...
public class PostProcessedByTimeHometownCFRecommender extends PostProcessByTimeRecommender {

	public PostProcessedByTimeHometownCFRecommender(Integer numberOfSimilarUsers,
